...
// echo $language;
$translations = json_decode(file_get_contents(__DIR__."/../lang/$language.json"), true);
    ...
    <div class="max-w-4xl mx-auto px-5 py-8">
        <div class="max-w-2xl mx-auto p-6">
            <div class="text-center mb-12">
                ...
                <?php }else{?>
                    <p class="font-medium" style="color: rgb(53, 119, 24)">レポートが正常に生成され送信されました！</p>
                <?php } ?> 
                </div>
            </div>
            <div class="space-y-4">
            ...
            <div class="pt-5">
               <button id="get_report" class="btn btn-link" style="color:blue"><span id="btnText">再送する場合はこちら</span></button>
            </div>
...
window.onload = function () {
    ...
    window.onpopstate = function () {
        alert("成功画面から戻ると、データが失われたりエラーが発生したりする可能性があります。");
        disableBack();
    };
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("book_consultation")?.addEventListener("click", function () {
        window.open(
            "https://timerex.net/s/contact_d1e0_257d/86059caa",
            "_blank"
        );
    });
