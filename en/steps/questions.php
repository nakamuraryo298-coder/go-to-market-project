    ...
    <div class="max-w-4xl mx-auto px-5 py-8">
        ...
        <div class="mb-6">
            ...
            <div class="w-full bg-gray-200 rounded-full h-2">
                <div id="progressBar"
                     class="h-2 rounded-full bg-blue-700 transition-all"
                     style="width:12%"></div>
            </div>
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    function loadQuestion(init = false){
        ...
        .then(data => {
            ...
            if(data.finished){
                const redirectUrl = '<?= BASE_URL;?>/en/gtm-assessment?step=challenges';
            ...
            document.getElementById('progress').innerText = 'Question '+(currentQuestionIndex+1)+' of '+data.total;
    ...
    document.getElementById('backBtn').addEventListener('click', function(){
        ...
        if(currentQuestionIndex === 0){
            ...
            fetch('<?= BASE_URL;?>/api/ajax/save-answer.php',{
                ...
                window.location.href = '<?= BASE_URL;?>/en/register?from=questions';
            });
            return;
        }
