...
$departmentMap = [
    'en' => [
        ...
        'corporate-planning'   => 'Corporate Planning Department',
        'other'                => 'Other',
    ]
];
...
function insertSoftBreaks($text) {
    ...
    // Insert zero-width space between every character except newlines
    $text = preg_replace('/(?<!\n)(.)/u', '$1&#8203;', $text);
...
<html>
    ...
    function getNextAction(string $revenueRange, string $grade): string
    {
        global $langData;

        $gradeOrder = ['D', 'C', 'B', 'A', 'S'];

        $currentIndex = array_search($grade, $gradeOrder, true);
        ...
        // If already S → return S content
        if ($nextGrade === null) {
            return $langData['nextActions'][$revenueRange]['S'] ?? '';
        }

        $key = $grade . '_' . $nextGrade;

        return $langData['nextActions'][$revenueRange][$key] ?? '';
    }
    ?>
        ...
        <tr>
            ...
            <td class="content" valign="top">
                ...
                <div class="main-title" style="width: 100%; margin-bottom: 35px; padding-top: 15px">
                   ...
                   <?php if($language=='en'){?>
                    <p style="margin:0; line-height:16px; color:#CACACA; font-weight: bold; float:right; font-family:'Montserrat', sans-serif;">                       
                        GTM Maturity Assessment by Grade                       
                    </p>
                    <?php }?>
                </div>
                    ...
                    <table class="overall-table">
                        <tr>
                            ...
                            <td class="overall-right" valign="top">
                                ...
                                <?php if($language=='en'){?>
                                <p  class="small-text text-color" style="font-family: 'Montserrat', sans-serif;color: #4c4c4c;margin-top: 15px;">
                                        ...
                                        <td align="center" valign="middle" width="100%">
                                            <div class="inner-gtm-div" style="margin-bottom:-30px; display: inline-block; text-align: center" >
                                                ...
                                                <div class="slash-cus" style="display: inline-block; margin: 0 8px; vertical-align: middle">
                                                    <img src="<?= $fontPath;?>images/slash-2.png" alt="" style="width: 20px";/>
                                                </div>
                ...
                <?php if($hasLowScore){?>
                <div class="feedback-wrapper metrics-wrapper" style="margin-bottom: 15px; margin-top: 15px">
                    <table width="100%" cellpadding="0" cellspacing="0" class="feedback-table">
                        ...
                        <tr style="border-radius: 10px; padding-bottom:0px" class="feedback-row">
                            <!-- LEFT -->
                            <td width="55%" class="feedback-left">
                                <p class="feedback-title">
                                    <?= ucfirst($cat) ?>
                                    <?php if ($language === 'ja' && isset($jaCategorySubLabels[$cat])): ?>
                                    <span style="font-size:9px;">
                                        <?= ___( $jaCategorySubLabels[$cat] ) .' - '.$score; ?>
                                    </span> 
                                    <?php endif; ?>  
                                </p>
                                <p class="feedback-text">
                                    <?= getFeedback($cat, $score); ?> 
                                </p>
                                <p class="stars"><?= renderStars($score); ?></p>
                            </td>

                            <!-- RIGHT -->
                            <td width="45%" class="feedback-right">
                                <div class="feedback-info" style="padding-bottom: 5px;">
                                    <span width="20%" class="tag"><?= getRevenueTag($revenue_range, $language); ?></span>
                                    <span width="10%" class="img-inline">
                                        <img src="<?= $fontPath;?>images/vector-arrow.png" style="position: relative; top: 1px" alt="" /></span>
                    ...
                    <tr>
                        ...
                        <td width="30%" valign="top" class="challenge-left">
                            <div class="next-step-box">
                                ...
                                <div class="text-area" style="margin-top:7px">
                                    <div class="en-text"><span style="margin-top:10px;line-height: 0.7;">GTM<br/>Challenges</span></div>
                                </div>
                            </div>
                                ...
                                <tr>
                                    <td style="padding-left: 20px;">
                                        <table class="list-table" width="100%" cellspacing="0" cellpadding="4">
                                            ...
                                            <tr>
                                                <td class="check"></td>
                                                <td style="padding-left: 5px;  font-size: 11px;  line-height: 1; color: #24394c; font-weight: bold; padding-top: 0px;">
                    ...
                    <tr>
                        <td width="30%" valign="top" class="challenge-left">
                            ...
                            <div class="next-step-box">
                                ...
                                <div class="text-area" style="margin-top:5px">
                                    <div class="en-text" style="line-height: 0.7;margin-top: -5px;">Next<br/>Actions</div>
                                </div>
                            </div>
                            ...
                            <div class="jp-text_plain">Maintenance</div>
                        ...
                        <td width="70%" valign="top" style="padding-left: 10px">
                            <table class="list-table" width="100%" cellspacing="0" cellpadding="10" style="background: #fff1e6; margin-top: 8px">
                                <tr>
                                    <?php if($language=='en'){?>
                                    <td width="14" valign="top" style="padding-right: 0;padding-left: 20px;">
                                        <img src="<?= $fontPath;?>images/Vector-icon.png" style="position: relative; top: 0px" alt="" />
                                    </td>
                                    <?php }?>
                                    <td style="padding-left: 2px; font-size: 12px; line-height: 1.2; color: #24394c; font-weight: bold;">
                                    <?php 
                                        $nextActionText = getNextAction($revenue_range, $assessmentGrade);
                                        echo e($nextActionText);
                                        ?>
                                    </td>
